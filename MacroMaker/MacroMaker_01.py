...
def createUI(pWindowTitle):
    ...
    global outputField
    outputField = mc.cmdScrollFieldReporter("outputField", width= 395, height=400, clear=clearValue, echoAllCommands=False, suppressInfo=True, suppressStackTrace=True, suppressResults=True, enable=True, suppressErrors=True)
    mc.setParent('..')
